# Generated by Django 3.0.8 on 2020-12-31 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_profit_share', to='api.TripRequest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_offloading_details', to='api.TripRequest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_loading_details', to='api.TripRequest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_expense_details', to='api.TripRequest')),
            ],
            options={
